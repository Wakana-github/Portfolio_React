...
function Projects() {
    ...
    const displayedProjects = isMobileView && !showAllProjects ? project_data.slice(0, 3) : project_data;

  return (
    <div id="projects" className='myProjects'>
        <h1 className="title projects-title">Project Library<img className='wing_icon' src={wing_icon_pink} alt=""/></h1>
