  ...
  return (
    ...
    <div className='footer'>
      ...
      <ul className="subNav">
        ...
        <li>
          <AnchorLink key='projects' offset={50} className='subNav-list' href="#myWork" onClick={() => setMenu('myWork')}>my work</AnchorLink>
        </li>
        <li>
          <AnchorLink key='projects' offset={50} className='subNav-list' href="#projects" onClick={() => setMenu('projects')}>projects</AnchorLink>
        </li>
        <li>
